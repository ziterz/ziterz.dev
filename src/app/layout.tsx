...
export const metadata: Metadata = {
  title: 'Ziady Mubaraq',
  description: 'Full-Stack Developer, Coding Mentor',
};
  ...
  return (
    <html lang='en'>
      <Head>
        ...
        <meta name='description' content='Full-Stack Developer, Coding Mentor' />
        ...
        <meta
          ...
          content='Full-Stack Developer, Coding Mentor'
        />
        <meta
          property='og:image'
