          ...
          <div className="container mx-auto" style={{ maxWidth: '1000px' }}>
            ...
            <div className="text-neutral-400 px-2 md:px-0">
              <p className="text-xl md:text-3xl py-10">
                ...
                >Lunash</a></span>, focusing on developing SaaS applications. At Lunash, we build <span className="text-white">AI-driven debt management solutions</span> and <span className="text-white">AI Chat Agents</span> that automatically handle debt collection and invoice reminders for customers of financial institutions across Indonesia, including regional banks, rural banks, P2P lenders, multifinance companies, and debt collection agencies.
                <br />
                <br />
