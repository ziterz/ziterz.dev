...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "<span class='text-pink-500 font-medium'>RIOT Hybrid Boardgame</span> with a native iOS companion app that integrates physical and digital elements using NFC technology for interactions.",
    thumbnail: "/static/riot-boardgame-thumb.jpeg",
    img: ["/static/riot-boardgame.jpeg"],
    tags: ["Xcode", "SwiftUI", "CoreNFC", "AVKit", "Swift"],
    footer: "Role: Lead iOS Developer, UI Designer, Artwork Creator"
  },
